...
function App() {
  ...
  const [showSolarPanelPage, setShowSolarPanelPage] = useState(false);
          ...
          <section id="products" className="py-32 px-4 bg-[#050505] relative overflow-hidden scroll-mt-28">
            ...
            <div className="container mx-auto max-w-6xl relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                <div className="relative cursor-pointer group" onClick={() => setShowSolarPanelPage(true)}>
                  <div className="relative rounded-2xl border border-white/[0.08] hover:border-white/40 transition-all duration-500 ease-out h-full overflow-hidden shadow-[inset_0_1px_1px_rgba(255,255,255,0.08)] group-hover:shadow-[0_25px_50px_rgba(0,0,0,0.5)] group-hover:scale-[1.03]">
                    {/* Background Image */}
                    <img
                      src="/media/kokok.png"
                    ...
                    />
                    {/* Dark overlay for text readability - brightens slightly on hover */}
                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-black/30 group-hover:from-black/80 group-hover:via-black/30 transition-all duration-500"></div>
                    {/* Content */}
                    <div className="relative z-10 p-6 h-full flex flex-col justify-end min-h-[180px]">
                      <div className="w-10 h-10 bg-white/10 backdrop-blur-xl rounded-lg flex items-center justify-center mb-3 border border-white/20 transition-all duration-300 group-hover:bg-orange-500 group-hover:text-white group-hover:border-orange-500">
                        <Sun size={18} className="text-white" />
                      </div>
                      <h4 className="font-semibold text-white text-lg mb-1 group-hover:text-orange-100 transition-colors">Adani Solar Panels</h4>
                      <p className="text-sm text-white/70 leading-relaxed group-hover:text-white transition-colors">High-efficiency mono-PERC technology engineered for Indian weather conditions.</p>
                      <div className="mt-4 opacity-0 transform translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 delay-100">
                        <span className="inline-flex items-center gap-2 px-4 py-2 bg-white text-black text-xs font-bold rounded-full">
